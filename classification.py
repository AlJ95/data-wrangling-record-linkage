...
# -----------------------------------------------------------------------------
# TODO 2.1 implement threshold classification
...
# -----------------------------------------------------------------------------
# TODO 2.2 implement minimum threshold classification
...
# -----------------------------------------------------------------------------
# TODO 2.3 implement weighted threshold classification
...
# TODO 3 implement weighted threshold classification
def automatic_weight_computation(rec_dict_a: dict, rec_dict_b: dict, compared_attribute_idx):
    """
    Method to determine automatically the weight of an attribute comparison based on the uniqueness
    of attribute values using log_2(|U|)
    :param rec_dict_a: records of data source A
    :param rec_dict_b: records of data source B
